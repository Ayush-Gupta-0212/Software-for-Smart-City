# main.tf — root module.
# Composes the three modules into a complete smart-city-ready environment.
...
module "vpc" {
  ...
  name                = "smart-city-${var.environment}"
  cidr                = var.vpc_cidr
...
module "security_groups" {
  ...
  name_prefix      = "smart-city-${var.environment}"
...
module "k3s_node" {
  ...
  name              = "smart-city-${var.environment}-k3s"
  ami               = local.ami_id
